        ...
        <div class="col-lg-4">
            <form action="doSignUp.php" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input id="email" type="email" name="email" required class="form-control" placeholder="name@example.com">
                    <div class="error text-danger text-end"></div>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input id="password" type="password" name="password" required class="form-control" placeholder="設定您的密碼">
                </div>
                <div class="mb-3">
                    <label for="repassword">確認密碼</label>
                    <input id="repassword" type="password" name="repassword" required class="form-control" placeholder="請再次輸入密碼">
                </div>
                <div class="mb-3">
