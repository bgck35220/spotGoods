...
$sqlUser = "SELECT * FROM coupon WHERE id = ?";
...
<body>
    ...
    <main>
        <div class="container pt-5 col-4">
            ...
            <?php if ($userExist > 0) : ?>
                <form action="couponUpdate.php " method="POST" class="updateForm">
                    <table class="table table-bordered  updateTable ">
                        ...
                        <tr>
                            <th>折扣項目</th>
                            <td class="p-1"> <input type="text" value="<?= $rowUser['text'] ?>" class="form-control p-2 m-0" placeholder="name" name="text"></td>
                        </tr>
                        <tr>
                            <th>折扣金額</th>
                            <td class="p-1"> <input type="text" value="<?= $rowUser['amount'] ?>" class="form-control p-2 m-0" placeholder="account" name="amount" ></td>
                        </tr>
                        <tr>
                            <th>數量</th>
